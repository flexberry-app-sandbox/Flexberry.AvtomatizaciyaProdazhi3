...
moduleForModel('i-i-s-avtomatizaciya-prodazhi3-подраз', 'Unit | Serializer | i-i-s-avtomatizaciya-prodazhi3-подраз', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-prodazhi3-подраз',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
