...
moduleForModel('i-i-s-avtomatizaciya-prodazhi3-менедж', 'Unit | Serializer | i-i-s-avtomatizaciya-prodazhi3-менедж', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-prodazhi3-менедж',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
