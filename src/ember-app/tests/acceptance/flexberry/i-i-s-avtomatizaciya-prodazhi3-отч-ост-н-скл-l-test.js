...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya prodazhi3 отч ост н скл l');

test('testing i-i-s-avtomatizaciya-prodazhi3-отч-ост-н-скл-l', function(assert) {
