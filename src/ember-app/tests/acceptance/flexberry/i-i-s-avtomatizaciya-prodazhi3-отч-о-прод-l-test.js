...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya prodazhi3 отч о прод l');

test('testing i-i-s-avtomatizaciya-prodazhi3-отч-о-прод-l', function(assert) {
